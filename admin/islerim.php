		  		...
		  		<div class="col-md-12 panel-primary">
		  			<div class="content-box-header panel-heading">
                          ...
                          <div class="panel-options">
								<a href="is-ekle.php" data-rel="collapse" style="color:white;"><i class="glyphicon glyphicon-plus"></i></a>
							</div>
                            ...
                            foreach ($is as $row) {  ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php if($row['is_devam'] == 1){ ?>
                                            ...
                                            <?php }elseif($row['is_devam'] == 0){ ?>
                                                <span class="glyphicon glyphicon-remove"></span>
                                        <?php  }?>
                                        </td>
                                        <td>
                                            <a href="is-duzenle.php?is_id=<?php echo $row['id'] ?>"  ><button class="btn btn-xs btn-primary "><span class="glyphicon glyphicon-edit"></span> Düzenle</button> </a>
                                            <br>
                                            <br>
