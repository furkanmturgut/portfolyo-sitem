		  	...
		  	<div class="row">
		  		...
		  		<div class="col-md-12 panel-primary">
					  ...
					  <form class="form-horizontal" method="POST" action="islem.php" role="form">
						...
						<div class="col-sm-9">
						  <input type="text" name="adi" class="form-control" placeholder="Yetenek adı giriniz" >
						 </div>
						</div>
						...
						<label for="inputPassword3" class="col-sm-2 control-label">Proje Fiyat</label>
							<div class="col-sm-9">
							 <input type="text" name="fiyat" class="form-control" placeholder="Yetenek yüzdesi giriniz" >
							 </div>
							</div>
						...
						<div class="col-sm-9">
						  <input type="text" name="url" class="form-control" placeholder="Yetenek adı giriniz" >
						 </div>
						</div>
