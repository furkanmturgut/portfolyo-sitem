		  		...
		  		<div class="col-md-12 panel-primary">
		  			<div class="content-box-header panel-heading">
                          ...
                          <div class="panel-options">
								<a href="proje-ekle.php" data-rel="collapse" style="color:white;"><i class="glyphicon glyphicon-plus"></i></a>
							</div>
                        ...
                        <?php
                            ...
                            foreach ($dil as $row) {  ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="proje-duzenle.php?proje_id=<?php echo $row['id'] ?>"  ><button class="btn btn-xs btn-primary "><span class="glyphicon glyphicon-edit"></span> Düzenle</button> </a>
                                            <br>
                                            <br>
                                            <a href="islem.php?proje_sil=<?php echo $row['id'] ?>"  ><button class="btn btn-xs btn-danger "><span class="glyphicon glyphicon-remove"></span> Sil</button> </a>
